...
Then(
  'KB link ex. "Endgame | Welcome to product-led sales" would be displayed',
  () => {
...
Then('User would see result example "tamagui.dev"', () => {
  cy.contains("designvault.io").scrollIntoView().should("exist");
});
...
Then(
  'Kb link ex. "20 Soft Skills for Better Engineering Leaders | Productboard" would be seen',
  () => {
    cy.contains(
      "20 Soft Skills for Better Engineering Leaders | Productboard"
    ).should("exist");
  }
);
...
When(
  'User clicks on a link ex. "https://www.designbetter.co/design-leadership-handbook/becoming-a-design-leader"',
  () => {
    cy.get(
      "body > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > div:nth-child(2) > div:nth-child(3) > a:nth-child(1)"
    ).click();
  }
);
