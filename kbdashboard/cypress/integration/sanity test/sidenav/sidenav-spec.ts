...
When("User navigates to Dashboard", () => {
  cy.visit(
    "https://gvv9dp5nt676r.a9ni7d1ff3m0e.ap-southeast-1.cs.amazonlightsail.com/"
  );
});
...
Then("User would see the Install KB Extension button", () => {
  cy.get('[id="menu-button-Install KB Extension"]').eq(0).should("be.visible");
});
...
Then(
  'User would see "Missing HTTP Security Headers - Bug Bounty Tips" shared link',
  () => {
    cy.contains("Missing HTTP Security Headers - Bug Bounty Tips")
      .scrollIntoView()
      .should("exist");
  }
);
...
Then('User would see "Afterparty" shared link', () => {
  cy.contains("Afterparty").scrollIntoView().should("exist");
});
...
Then(
  'User would see "Blockchain & Crypto 101: Guide for Beginners | Binance Academy" shared link',
  () => {
    cy.contains(
...
Then(
  'User would see "How to improve your design when user testing is not viable" shared link',
  () => {
    cy.contains("How to improve your design when user testing is not viable")
      .scrollIntoView()
      .should("exist");
  }
);
...
Then('User would see "Terraform AWS modules" shared link', () => {
  cy.contains("Terraform AWS modules").scrollIntoView().should("exist");
});
...
Then(
  'User would see "The Ultimate Guide to Onboarding Software Engineers - Leadership Garden" shared link',
  () => {
    cy.contains(
...
Then(
  'User would see "How Ramp’s early adoption of stablecoins increased our Corporate Treasury returns" shared link',
  () => {
    cy.contains(
...
Then(
  'User would see "This will really add value to efficiency when doing FE dev." shared link',
  () => {
    cy.contains("This will really add value to efficiency when doing FE dev.")
      .scrollIntoView()
      .should("exist");
  }
);
...
Then(
  'User would see "The Growth Mindset - What is Growth Mindset - Mindset Works" shared link',
  () => {
    cy.contains("The Growth Mindset - What is Growth Mindset - Mindset Works")
      .scrollIntoView()
      .should("exist");
  }
);
...
Then(
  'User would see "Startup Engineering Hiring Anti-Patterns" shared link',
  () => {
    cy.contains("Startup Engineering Hiring Anti-Patterns")
      .scrollIntoView()
      .should("exist");
  }
);
...
Then(
  'User would see "20 Soft Skills for Better Engineering Leaders | Productboard" shared link',
  () => {
    cy.contains("20 Soft Skills for Better Engineering Leaders | Productboard")
      .scrollIntoView()
      .should("exist");
  }
);
...
Then('User would see "Coaching Real Leaders" shared link', () => {
  cy.contains("Coaching Real Leaders").scrollIntoView().should("exist");
});
...
Then(
  'User would see "4 Email Marketing Strategies for Your App Launch - Messapps" shared link',
  () => {
    cy.contains("4 Email Marketing Strategies for Your App Launch - Messapps")
      .scrollIntoView()
      .should("exist");
  }
);
...
Then('User would see "Advanced Remix" shared link', () => {
  cy.contains("Advanced Remix").scrollIntoView().should("exist");
});
...
Then('User would see "How to develop product sense" shared link', () => {
  cy.contains("How to develop product sense").scrollIntoView().should("exist");
});
...
Then('User would see "9 Habits Of Productive People" shared link', () => {
  cy.contains("9 Habits Of Productive People").scrollIntoView().should("exist");
});
...
Then('User would see "Positive Thinking Mind" shared link', () => {
  cy.contains("Positive Thinking Mind").scrollIntoView().should("exist");
});
...
Then('User would see "QA trends in 2022 to prioritize" shared link', () => {
  cy.contains("QA trends in 2022 to prioritize")
    .scrollIntoView()
    .should("exist");
});
...
Then(
  'User would see "The art of remote communication - Remote Work" shared link',
  () => {
    cy.contains("The art of remote communication - Remote Work")
      .scrollIntoView()
      .should("exist");
  }
);
...
Then(
  'User would see "Endgame | Welcome to product-led sales" shared link',
  () => {
    cy.contains("Endgame | Welcome to product-led sales")
      .scrollIntoView()
      .should("exist");
  }
);
...
Then('User would see "Fiat Republic" shared link', () => {
  cy.contains("Fiat Republic").scrollIntoView().should("exist");
});
...
Then(
  'User would see "How to Present a Strategy in 6 Slides" shared link',
  () => {
    cy.contains("How to Present a Strategy in 6 Slides")
      .scrollIntoView()
      .should("exist");
  }
);
...
Then('User would see "scrapingfish.com" shared link', () => {
  cy.contains("scrapingfish.com").scrollIntoView().should("exist");
});
