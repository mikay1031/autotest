...
declare global {
  ...
  Cypress.Commands.add('viewCategories', () => {
    ...
    cy.get('body > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(3) > div:nth-child(15) > button:nth-child(1)').scrollIntoView().should('be.visible')
    ...
    cy.get('body > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(3) > div:nth-child(18) > button:nth-child(1)').scrollIntoView().should('be.visible')
    ...
    cy.get('body > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(3) > div:nth-child(23) > button:nth-child(1)').scrollIntoView().should('be.visible')
  });
  ...
  Cypress.Commands.add('clickCryptocurrency', () => {
    cy.get('#menu-button-Cryptocurrency').scrollIntoView().should('be.visible').click()
  ...
  Cypress.Commands.add('clickEngineering', () => {
    cy.get('#menu-button-Engineering').scrollIntoView().should('be.visible').click()
  ...
  Cypress.Commands.add('clickLeadership', () => {
    cy.get('#menu-button-Leadership').scrollIntoView().should('be.visible').click()
  
  
  });
  
  Cypress.Commands.add('clickManagement', () => {
    cy.get('#menu-button-Management').scrollIntoView().should('be.visible').click()
  ...
  Cypress.Commands.add('clickMarketing', () => {
    cy.wait(2000)
    cy.get('#menu-button-Marketing').scrollIntoView().should('be.visible').click()
  ...
  Cypress.Commands.add('clickProductManagement', () => {
    cy.get('body > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(3) > div:nth-child(15) > button:nth-child(1)').scrollIntoView().should('be.visible').click()
  
  
  });
  
  Cypress.Commands.add('clickProductivity', () => {
    cy.get('#menu-button-Productivity').scrollIntoView().should('be.visible').click()
  
  
  });
  
  Cypress.Commands.add('clickPsychology', () => {
    cy.get('#menu-button-Psychology').scrollIntoView().should('be.visible').click()
  
  
  });
  
  Cypress.Commands.add('clickQualityAssurance', () => {
    cy.get('body > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(3) > div:nth-child(18) > button:nth-child(1)').scrollIntoView().should('be.visible').click()
  ...
  Cypress.Commands.add('clickToolsandSoftware', () => {
    cy.get('body > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(3) > div:nth-child(23) > button:nth-child(1)').click()
